 ...
 */
export declare function buildReinvokeArgs(selfPath: string, agentName: AgentName, baseBranch: string | undefined, tmuxMode: TmuxMode | undefined, useLocalBranch: boolean, trusted: boolean): readonly string[];
/**
